...
<svg viewBox="0 0 640 254" xmlns="http://www.w3.org/2000/svg" role="img"
  ...
  <desc id="car-desc">At 35% of annual income: $50,000 income supports $17,500;
  $75,000 supports $26,250; $100,000 supports $35,000; $150,000 supports $52,500.</desc>

  <g font-family="'Trebuchet MS', 'Avenir Next', sans-serif" font-size="13">
    <!-- row: income label, bar, value label -->
